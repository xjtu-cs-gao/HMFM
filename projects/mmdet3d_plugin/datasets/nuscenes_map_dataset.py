...
class CustomNuScenesLocalMapDatasetWithSatelliteMap(CustomNuScenesDataset):
    r"""NuScenes Dataset.
    ...
    def __init__(self,
                 ...
                 queue_length=4, # 1
                 bev_size=(200, 200),   # (200, 100)
                 pc_range=[-51.2, -51.2, -5.0, 51.2, 51.2, 3.0],  # [-15.0, -30.0, -2.0, 15.0, 30.0, 2.0]
                 overlap_test=False, 
                 fixed_ptsnum_per_line=-1,
        ...
        f = open(os.path.join(self.satellite_map_root, 'map_prior.json'), 'r')
        content = f.read()
    ...
    def get_data_info(self, index):
        ...
        input_dict = dict(
            ...
            satellite_map_path=os.path.join(self.satellite_map_root, self.satellite_map_config[info['pose_token']]),
            sweeps=info['sweeps'],
