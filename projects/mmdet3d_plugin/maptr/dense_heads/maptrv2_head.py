...
class MapTRv2Head(DETRHead):
    ...
    @force_fp32(apply_to=('mlvl_feats', 'prev_bev', 'satellite_map_feat'))
    def forward(self, mlvl_feats, lidar_feat, satellite_map_feat, img_metas, prev_bev=None,  only_bev=False):
        """Forward function.
        Args:
